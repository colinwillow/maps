// Reading the baked chunk format. The writer is tools/pdx/chunkfmt.py and the two
// are checked against each other by tools/pdx/readchunk.py, which reads the same
