...
Everything it writes lands in public/pdx/data/ and is committed, because the
runtime is a static page with no build step and GitHub Pages has to serve it.

Read tools/pdx/README.md for the shape of the whole pipeline. The order below
...
OUT = os.path.abspath(os.path.join(HERE, "..", "..", "public", "pdx", "data"))
